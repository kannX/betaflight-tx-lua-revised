return {
   ...
   fields = {
      { x = 40,  y = 14, vals = { 9 }, min = 0, max = 1, to = SMLSIZE, table = { [0] = "OFF", "ON" }, upd = function(self) self.updateRateTables(self) end },
      { x = 40,  y = 24, vals = { 1 }, min = 1, max = 32, to = SMLSIZE, upd = function(self) self.updatePidRateTable(self) end },
      { x = 40,  y = 34, vals = { 2 }, min = 1, max = 16, to = SMLSIZE, },
      { x = 105, y = 14, vals = { 4 }, min = 0, max = 9, to = SMLSIZE, table = { [0] = "OFF", "ONESHOT125", "ONESHOT42", "MULTISHOT","BRUSHED", "DSHOT150", "DSHOT300", "DSHOT600","DSHOT1200", "PROSHOT1000" } },
      { x = 105, y = 24, vals = { 3 }, min = 0, max = 1, to = SMLSIZE, table = { [0] = "OFF", "ON" } },
      { x = 105,  y = 34, vals = { 5, 6 }, min = 200, max = 32000, to = SMLSIZE },
      { x = 60, y = 44, vals = { 7, 8 }, min = 2000, max = 32000, to = SMLSIZE, scale = 100 },
   },
